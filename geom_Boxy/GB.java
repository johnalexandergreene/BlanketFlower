...
public class GB{
   ...
   */
  public static final List<BCell> getPolygonCellFill(BPolygon polygon){
    //get twist
   ...
   * ################################
   * CELL MASS POLYGON
   * Given a mass of cells, get the polygon/s defined by that mass
   * ################################
   */
  
  public static final List<BPolygon> getCellMassPolygons(List<BCell> cells){
    return null;//TODO
  }
